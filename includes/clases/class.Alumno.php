...
class Alumno extends Persona
{
    ...
    {
        $query = "SELECT cuentas_monto.id_concepto, cuentas_concepto.concepto,
            cuentas_monto.monto, COALESCE(pagado, 0) AS pagado, cuentas_monto.monto - pagado AS deuda
            FROM alumno_grupo
            JOIN grupo ON grupo.id_grupo = alumno_grupo.id_grupo
            JOIN grado ON grado.id_grado = grupo.id_grado
            JOIN area ON area.id_area = grado.id_area
            ...
            JOIN cuentas_cuenta ON cuentas_cuenta.id_concepto = cuentas_monto.id_concepto
